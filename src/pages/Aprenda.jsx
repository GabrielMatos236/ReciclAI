...
function Aprenda() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pb-24">
      ...
      {/* Header */}
      <div className="sticky top-0 z-30 bg-gradient-to-tr from-blue-950 to-blue-700 h-28 rounded-b-[12px] flex flex-col items-center justify-center relative flex-shrink-0">
        <button
