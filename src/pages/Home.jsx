...
import { User, Recycle, MapPin, Trophy, Camera as CameraIcon } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-100 pb-24">
      ...
      <div className="bg-purple-900 px-6 pt-12 pb-8 rounded-b-3xl">
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="bg-purple-700 p-2 rounded-full cursor-pointer">
        ...
        <div className="bg-green-300 rounded-3xl p-6 shadow-lg">
          ...
          <div className="flex justify-around items-center">
            <div className="text-center">
              ...
              <p className="text-purple-900 text-3xl font-bold">42</p>
            </div>
            <div className="w-px h-12 bg-purple-900 opacity-30"></div>
            <div className="text-center">
              <p className="text-purple-900 text-sm">Pontos</p>
              <p className="text-purple-900 text-3xl font-bold">1250</p>
            </div>
          </div>
        </div>
      </div>
